<%@ Page
    ...
    Inherits="SOPOINV.Forms.Payments"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel ID="pnlButtons" runat="server" Visible="true" CssClass="w3-panel w3-margin-0">
        <div class="w3-col s8">
            ...
            <asp:Button ID="btnShowDetails" CssClass="w3-btn w3-green ButtonStyle" runat="server" Text="Show Details" OnClick="btnShowDetails_Click" Visible="false" />
            <asp:Button ID="btnHideDetails" CssClass="w3-btn w3-green ButtonStyle" runat="server" Text="Hide Details" OnClick="btnHideDetails_Click" Visible="false" />
    ...
    <div runat="server" id="pnlBalance">
