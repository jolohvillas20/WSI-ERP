<%@ Page
    Title="Inventory Transactions - MIS"
    Language="C#"
    MasterPageFile="~/Site Master/SiteMaster.Master"
    AutoEventWireup="true"
    CodeBehind="MIS.aspx.cs"
    Inherits="SOPOINV.Forms.InventoryManagement.InventoryTransactions.MIS"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="panel panel-default card" style="border-radius: 0px; background-color: white; margin-top: 15px;">
        <div class="w3-padding">
            ...
            <hr />
            <asp:Button runat="server" ID="btnView" Text="View MIS List" CssClass="buttonStyle w3-green" OnClick="btnView_Click" />
            <asp:Button runat="server" ID="btnCreate" Text="Create New MIS" CssClass="buttonStyle w3-green" OnClick="btnCreate_Click" />
        </div>
            ...
            <div class="modal-body">
                <table>
                    <tr>
                        ...
                        <td>
                            <h5>
                                <asp:LinkButton runat="server" href="MIS.aspx" CssClass="buttonStyle" Font-Underline="false">MIS</asp:LinkButton></h5></td><td>
                            <h5>
