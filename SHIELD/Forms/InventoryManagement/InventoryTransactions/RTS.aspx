<%@ Page
    Title="Inventory Transactions - RTS"
    Language="C#"
    MasterPageFile="~/Site Master/SiteMaster.Master"
    AutoEventWireup="true"
    CodeBehind="RTS.aspx.cs"
    Inherits="SOPOINV.Forms.InventoryManagement.InventoryTransactions.RTS"
    ...
    <div class="panel panel-default card" style="border-radius: 0px; background-color: white; margin-top: 15px;">
        <div class="w3-padding">
            ...
            <div class="w3-padding-top">
                <asp:Button runat="server" ID="btnView" Text="View Requests" CssClass="buttonStyle w3-green" OnClick="btnView_Click" />
                <asp:Button runat="server" ID="btnCreate" Text="Create New Request" CssClass="buttonStyle w3-green" OnClick="btnCreate_Click" />
                <asp:Button runat="server" ID="btnRecieve" Text="Recieve Items" CssClass="buttonStyle w3-green" OnClick="btnRecieve_Click" />
            </div>
        </div>
        <div runat="server" id="dvView" class="w3-padding" visible="false">
            <div>
        ...
        <div runat="server" id="dvCreate" class="w3-padding" visible="false">
            create
        </div>
        <div runat="server" id="dvRecieve" class="w3-padding" visible="false">
            recieve
        </div>
    </div>
