<%@ Page
    Title="Inventory Transactions - Update Forex"
    Language="C#"
    MasterPageFile="~/Site Master/SiteMaster.Master"
    AutoEventWireup="true"
    CodeBehind="UpdateForex.aspx.cs"
    Inherits="SOPOINV.Forms.InventoryManagement.InventoryTransactions.UpdateForex"
    ...
    <div class="panel panel-default card" style="border-radius: 0px; background-color: white; margin-top: 15px;">
        <div class="w3-padding">
            ...
            <div class="tab-content">
                <div id="UF" class="tab-pane fade in active" style="height: 370px;">
                            ...
                            <div class="w3-padding">
                                ...
                                <div class="searchHeader">
                                    <div class="searchLeft">
                                        <asp:TextBox Style="float: left" class="w3-input w3-border textBoxBorderRadius" runat="server" ID="txtForexRate" Placeholder="Forex Rate"></asp:TextBox>
                                        <%--<asp:Button Style="float: left" runat="server" class="searchButtonStyle " ID="btnSearchInput" OnClick="btnSearchInput_Click" />--%>
                                        <asp:DropDownList runat="server" ID="ddlCurrency" Style="float: left" class="w3-input w3-border textBoxBorderRadius"></asp:DropDownList>
                                        <asp:Button runat="server" class="textBoxBorderRadius " ID="btnClearFE" CssClass="deleteButtonStyle" OnClick="btnClearFE_Click" Height="30px" Width="30px"></asp:Button>
                                        <asp:Button runat="server" class="textBoxBorderRadius " ID="btnSaveFE" CssClass="saveButtonStyle" OnClick="btnSaveFE_Click" Height="30px" Width="30px"></asp:Button>
                                    </div>
                                </div>
                                <div>
                                    <asp:GridView runat="server" ID="gvForexRate"
                                        OnRowDataBound="gvForexRate_RowDataBound" OnPageIndexChanging="gvForexRate_PageIndexChanging" PageSize="10"
