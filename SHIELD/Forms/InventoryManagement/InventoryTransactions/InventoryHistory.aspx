<%@ Page
    ...
    CodeBehind="InventoryHistory.aspx.cs"
    Inherits="SOPOINV.Forms.InventoryHistory"
    ...
    <div class="panel panel-default card" style="border-radius: 0px; background-color: white; margin-top: 15px;">
        <div class="w3-padding">
            ...
            <ul class="nav nav-tabs">
                ...
                <li class="active"><a href="#IH">Inventory History - Inquiry</a></li>
                <li><a href="InventoryReports.aspx">Inventory Reports</a></li>
                <li><a href="UpdateForex.aspx">Update Forex</a></li>
            </ul>--%>

            <div class="tab-content">
                <div id="IH" class="tab-pane fade in active" style="height: 370px;">
                    <asp:UpdatePanel runat="server">
                        <ContentTemplate>
                            <div class="w3-padding">
                                <div class="searchHeader">
                                    <div class="searchLeft">
                                        <asp:TextBox Style="float: left" class="w3-input w3-border textBoxBorderRadius" runat="server" ID="txtSearchInput" Placeholder="Search Serial Number"></asp:TextBox>
                                ...
                                <asp:GridView ID="grvInventoryHistory" runat="server"
                                    OnRowDataBound="grvInventoryHistory_RowDataBound" OnPageIndexChanging="grvInventoryHistory_PageIndexChanging" PageSize="10"
                                ...
                                <br />
                                <asp:GridView ID="gvCustomerDetail" runat="server"
                                    OnRowDataBound="gvCustomerDetail_RowDataBound"
