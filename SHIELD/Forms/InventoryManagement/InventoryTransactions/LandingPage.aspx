<%@ Page 
    Title="Inventory Transactions - Landing Page"
    Language="C#"
    MasterPageFile="~/Site Master/SiteMaster.Master"
    AutoEventWireup="true"
    CodeBehind="LandingPage.aspx.cs"
    Inherits="SOPOINV.Forms.InventoryManagement.InventoryTransactions.LandingPage"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="panel panel-default card" style="border-radius: 0px; background-color: white; margin-top: 15px;">
        <div class="w3-padding">
            ...
            <h3 class="labelStyle2">
                <asp:Button runat="server" ID="btnMenu" Text="Inventory Transactions Menu" Style="border: none; background-color: white" /></h3>
    ...
    <div id="dvMenu" class="w3-modal w3-round" runat="server" visible="true" style="z-index: 1400; background-color: transparent black; display: block; padding-top: 5%">
        <div class="w3-modal-content w3-card-4 w3-round" style="width:34%">
            <div class="modal-header w3-blue">
                ...
                <div>
                    <asp:Button runat="server" ID="btnCloseMenu" class="w3-large w3-display-topright w3-blue" Style="border: none" Text="X" />
                </div>
            </div>
